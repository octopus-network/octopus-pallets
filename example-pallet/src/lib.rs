...
pub mod pallet {
    ...
    impl<T: Config> Pallet<T> {
        ...
        #[pallet::weight(195_000_0000)]
        pub fn transfer(origin: OriginFor<T>, to: T::AccountId, amount: BalanceOf<T>, _r_id: ResourceId) -> DispatchResult {
        ...
        #[pallet::weight(195_000_0000)]
        pub fn mint_erc721(origin: OriginFor<T>, recipient: T::AccountId, id: U256, metadata: Vec<u8>, _r_id: ResourceId) -> DispatchResult {
            T::BridgeOrigin::ensure_origin(origin)?;
