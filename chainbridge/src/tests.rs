...
//         );
//
//         assert_events(vec![Event::<Test>::ChainWhitelisted(0)]);
//     })
// }
//
// #[test]
...
//
//         assert_events(vec![
//             Event::RelayerAdded(RELAYER_A),
//             Event::RelayerAdded(RELAYER_B),
//             Event::RelayerAdded(RELAYER_C),
//             Event::RelayerRemoved(RELAYER_B),
//         ]);
//     })
// }
//
...
//
//         assert_events(vec![
//             Event::VoteFor(src_id, prop_id, RELAYER_A),
//             Event::VoteAgainst(src_id, prop_id, RELAYER_B),
//             Event::VoteFor(src_id, prop_id, RELAYER_C),
//             Event::ProposalApproved(src_id, prop_id),
//             Event::ProposalSucceeded(src_id, prop_id),
//         ]);
//     })
// }
//
...
//             Event::VoteFor(src_id, prop_id, RELAYER_A),
//             Event::VoteAgainst(src_id, prop_id, RELAYER_B),
//             Event::VoteAgainst(src_id, prop_id, RELAYER_C),
//             Event::ProposalRejected(src_id, prop_id),
//         ]);
//     })
// }
//
...
//         assert_events(vec![
//             Event::VoteFor(src_id, prop_id, RELAYER_A),
//             Event::RelayerThresholdChanged(1),
//             Event::ProposalApproved(src_id, prop_id),
//             Event::ProposalSucceeded(src_id, prop_id),
//         ]);
//     })
...
//         assert_eq!(prop, expected);
//
//         assert_events(vec![Event::VoteFor(
